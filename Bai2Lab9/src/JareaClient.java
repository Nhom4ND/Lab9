 ...
 * @author Welcome
 */
public class JareaClient extends javax.swing.JFrame {

    /**
     * Creates new form JareaClient
     */
    public JareaClient() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JareaClient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JareaClient().setVisible(true);
            }
        });
    }
